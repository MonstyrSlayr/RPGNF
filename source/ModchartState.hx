...
class ModchartState 
{
    ...
    function new()
    {
				...
				setVar("noteInvert", FlxG.save.data.noteInvert);
				...
				setVar("dadstartx", PlayState.dad.x);
				setVar("dadstarty", PlayState.dad.y);
				setVar("bfstartx", PlayState.boyfriend.x);
				setVar("bfstarty", PlayState.boyfriend.y);
				setVar("gfstartx", PlayState.gf.x);
				setVar("gfstarty", PlayState.gf.y);
				...
				Lua_helper.add_callback(lua,"trace", function (string:String) {
					trace('Trace from modchart: ' + string);
				});
				...
				Lua_helper.add_callback(lua,"FlipActorX", function(id:String) {
					getActorByName(id).flipX = !getActorByName(id).flipX;
				});
				...
				Lua_helper.add_callback(lua,"tweenPosQuartOut", function(id:String, toX:Int, toY:Int, time:Float, onComplete:String) {
					FlxTween.tween(getActorByName(id), {x: toX, y: toY}, time, {ease: FlxEase.quartOut, onComplete: function(flxTween:FlxTween) { if (onComplete != '' && onComplete != null) {callLua(onComplete,[id]);}}});
				});

				Lua_helper.add_callback(lua,"tweenPosSineInOutPingPong", function(id:String, toX:Int, toY:Int, time:Float, onComplete:String) {
					FlxTween.tween(getActorByName(id), {x: toX, y: toY}, time, {ease: FlxEase.quartOut, type: FlxTween.PINGPONG, loopDelay:0, onComplete: function(flxTween:FlxTween) { if (onComplete != '' && onComplete != null) {callLua(onComplete,[id]);}}});
				});
				...
				Lua_helper.add_callback(lua,"tweenAngleQuartOut", function(id:String, toAngle:Int, time:Float, onComplete:String) {
					FlxTween.tween(getActorByName(id), {angle: toAngle}, time, {ease: FlxEase.quartOut, onComplete: function(flxTween:FlxTween) { if (onComplete != '' && onComplete != null) {callLua(onComplete,[id]);}}});
				});
