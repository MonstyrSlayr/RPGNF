...
class NoteInvertOption extends Option
{
	...
	{
		FlxG.save.data.noteInvert = !FlxG.save.data.noteInvert;
		display = updateDisplay();
		return true;
	}
	...
	{
		return FlxG.save.data.noteInvert ? "Note Inversion" : "No Note Inversion";
	}
}
...
class TextEffectOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.texteffects = !FlxG.save.data.texteffects;
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "Text Effects " + (FlxG.save.data.texteffects ? "on" : "off");
}